...
window.onload = function() {
    ...
    for (let o of PROGRESS) if (localStorage.getItem('puzzleProgress_' + o.hash) == (o.puzzles - 1)) {
        const params = {
          'type': 'flower',
          'width': 58,
          'height': 58,
